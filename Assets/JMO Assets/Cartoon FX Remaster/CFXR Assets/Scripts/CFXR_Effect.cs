...
namespace CartoonFX
{
	...
	{
		public float Duration => _ps.main.duration;
		private ParticleSystem _ps;
		private Action _onDoneParticle;
		private bool _isOneTime = true;
		public void OnComplete(Action onDone,bool isOneTime = true)
		{
			_isOneTime = isOneTime;
			_onDoneParticle += onDone;
		}
		
		private void OnParticleSystemStopped()
		{
			_onDoneParticle?.Invoke();
			if (isFadingOut) _onDoneParticle = null;
		}
