...
{
    /// <summary>
    ///     A basic logger implementation to be able to log intelligently additional informations about the plugin's internal
    ///     mechanism.
    /// </summary>
            ...
            if (Level <= Loglevels.Exception)
                try
                {
                    ...
                    else
                    {
                        ...
                        {
                            sb.AppendFormat("{0}: {1} {2}", counter++.ToString(), exception.Message,
                    ...
                    Debug.LogError(string.Format(FormatEx,
                        GetFormattedTime(),
                        division,
                        msg,
                        exceptionMessage,
