...
namespace Org.BouncyCastle.Crypto.EC
{
    public sealed class CustomNamedCurves
    {
        ...
        {
            var holder = (X9ECParametersHolder)nameToCurve[Platform.ToUpperInvariant(name)];
        ...
        {
            var holder = (X9ECParametersHolder)oidToCurve[oid];
            return holder == null ? null : holder.Parameters;
        }
            ...
            : X9ECParametersHolder
        {
            ...
            {
                byte[] S = null;
                var curve = ConfigureCurve(new Curve25519());
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var curve = ConfigureCurve(new SecP128R1Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var glv = new GlvTypeBParameters(
                    ...
                    176);
                var curve = ConfigureCurveGlv(new SecP160K1Curve(), glv);
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var curve = ConfigureCurve(new SecP160R1Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var curve = ConfigureCurve(new SecP160R2Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var glv = new GlvTypeBParameters(
                    ...
                    208);
                var curve = ConfigureCurveGlv(new SecP192K1Curve(), glv);
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var curve = ConfigureCurve(new SecP192R1Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var glv = new GlvTypeBParameters(
                    ...
                    240);
                var curve = ConfigureCurveGlv(new SecP224K1Curve(), glv);
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var curve = ConfigureCurve(new SecP224R1Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var curve = ConfigureCurve(new SecP256R1Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var curve = ConfigureCurve(new SecP384R1Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var curve = ConfigureCurve(new SecP521R1Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var curve = ConfigureCurve(new SecT113R1Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var curve = ConfigureCurve(new SecT113R2Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var curve = ConfigureCurve(new SecT131R1Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var curve = ConfigureCurve(new SecT131R2Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            {
                byte[] S = null;
                var curve = ConfigureCurve(new SecT163K1Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var curve = ConfigureCurve(new SecT163R1Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var curve = ConfigureCurve(new SecT163R2Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var curve = ConfigureCurve(new SecT193R1Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var curve = ConfigureCurve(new SecT193R2Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            {
                byte[] S = null;
                var curve = ConfigureCurve(new SecT233K1Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var curve = ConfigureCurve(new SecT233R1Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            {
                byte[] S = null;
                var curve = ConfigureCurve(new SecT239K1Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            {
                byte[] S = null;
                var curve = ConfigureCurve(new SecT283K1Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var curve = ConfigureCurve(new SecT283R1Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            {
                byte[] S = null;
                var curve = ConfigureCurve(new SecT409K1Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var curve = ConfigureCurve(new SecT409R1Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            {
                byte[] S = null;
                var curve = ConfigureCurve(new SecT571K1Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var curve = ConfigureCurve(new SecT571R1Curve());
                var G = new X9ECPoint(curve, Hex.Decode("04"
