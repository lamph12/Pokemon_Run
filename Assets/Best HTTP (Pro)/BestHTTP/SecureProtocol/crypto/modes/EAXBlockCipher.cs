...
namespace Org.BouncyCastle.Crypto.Modes
{
	...
	public class EaxBlockCipher
        : IAeadBlockCipher
    {
        private readonly byte[] associatedTextMac;
        ...
        private readonly byte[] nonceMac;
            ...
            int outOff)
        {
            ...
            for (var i = 0; i != len; i++) resultLen += Process(inBytes[inOff + i], outBytes, outOff + resultLen);
            ...
            bool clearMac)
        {
            ...
            if (clearMac) Array.Clear(macBlock, 0, macBlock.Length);
...
//                InitCipher();
        ...
        private bool VerifyMac(byte[] mac, int off)
        {
            ...
            for (var i = 0; i < macSize; i++) nonEqual |= macBlock[i] ^ mac[off + i];
