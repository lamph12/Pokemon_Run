...
namespace Org.BouncyCastle.Crypto.Modes
{
        ...
        : IAeadBlockCipher
    {
            ...
            ICipherParameters parameters)
        {
            ...
            if (nonce == null || nonce.Length < 1) throw new ArgumentException("IV must be at least 1 byte");
        ...
        public int DoFinal(byte[] output, int outOff)
        {
            ...
            if (extra > 0) gCTRPartial(bufBlock, 0, extra, output, outOff);
        ...
        private unsafe byte[] GetNextCounterBlock()
        {
            ...
            if (tmpBlock == null)
                ...
                tmpBlock[0] = tmpBlock[1] = tmpBlock[2] = tmpBlock[3] = tmpBlock[4] = tmpBlock[5] = tmpBlock[6] =
 tmpBlock[7] = tmpBlock[8] = tmpBlock[9] = tmpBlock[10] = tmpBlock[11] = tmpBlock[12] = tmpBlock[13] = tmpBlock[14] =
 tmpBlock[15] = 0;
            // TODO Sure would be nice if ciphers could operate on int[]
