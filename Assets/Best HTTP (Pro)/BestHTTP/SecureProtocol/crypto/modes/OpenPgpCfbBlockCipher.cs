...
namespace Org.BouncyCastle.Crypto.Modes
{
        ...
        : IBlockCipher
    {
        ...
        private readonly byte[] FR;
        private readonly byte[] FRE;
            ...
            int outOff)
        {
            ...
            if (outOff + blockSize > outBytes.Length) throw new DataLengthException("output buffer too short");
            ...
            else if (count == 0)
            {
                ...
                for (var n = 0; n < blockSize; n++) FR[n] = outBytes[outOff + n] = EncryptByte(input[inOff + n], n);
