...
namespace Org.BouncyCastle.Crypto.Tls
{
        ...
        : AbstractTlsKeyExchange
    {
        ...
        public override void Init(TlsContext context)
        {
            ...
            if (mTlsSigner != null) mTlsSigner.Init(context);
        }
        ...
        public override void GenerateClientKeyExchange(Stream output)
        {
            ...
            if (mAgreementCredentials == null)
                mDHAgreePrivateKey = TlsDHUtilities.GenerateEphemeralClientKeyExchange(mContext.SecureRandom,
        ...
        public override void ProcessClientKeyExchange(Stream input)
        {
            ...
            var Yc = TlsDHUtilities.ReadDHParameter(input);

            mDHAgreePublicKey = TlsDHUtilities.ValidateDHPublicKey(new DHPublicKeyParameters(Yc, mDHParameters));
        }
