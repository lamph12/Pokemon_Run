...
namespace Org.BouncyCastle.Crypto.Tls
{
    public sealed class ProtocolVersion
    {
        ...
        {
            FullVersion = v & 0xffff;
            this.name = name;
        }

        public int FullVersion { get; }

        public int MajorVersion => FullVersion >> 8;

        public int MinorVersion => FullVersion & 0xff;

        public bool IsDtls => MajorVersion == 0xFE;

        public bool IsSsl => this == SSLv3;

        public bool IsTls => MajorVersion == 0x03;

        public ProtocolVersion GetEquivalentTLSVersion()
        {
            if (!IsDtls) return this;
            if (this == DTLSv10) return TLSv11;
            return TLSv12;
        }
        ...
        public bool IsEqualOrEarlierVersionOf(ProtocolVersion version)
        {
            ...
            var diffMinorVersion = version.MinorVersion - MinorVersion;
        ...
        {
            return other != null && FullVersion == other.FullVersion;
        }
