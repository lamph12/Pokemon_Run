...
namespace Org.BouncyCastle.Crypto.Tls
{
        ...
        : TlsKeyExchange
    {
        ...
        public virtual void Init(TlsContext context)
        {
            ...
            var clientVersion = context.ClientVersion;
        ...
        {
            if (!RequiresServerKeyExchange) throw new TlsFatalAlert(AlertDescription.unexpected_message);
        }
        ...
        {
            var signature = DigitallySigned.Parse(mContext, input);
            var signatureAlgorithm = signature.Algorithm;
