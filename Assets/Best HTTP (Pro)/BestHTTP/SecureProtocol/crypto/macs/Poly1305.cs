...
namespace Org.BouncyCastle.Crypto.Macs
{
    ...
    ///     The polynomial calculation in this implementation is adapted from the public domain
    ///     <a
    ///         href="https://github.com/floodyberry/poly1305-donna">
    ///         poly1305-donna-unrolled
    ///     </a>
    ///     C implementation
        ...
        : IMac
    {
        ...
        private void ProcessBlock()
        {
            ...
            var tp0 = mul32x32_64(h0, r0) + mul32x32_64(h1, s4) + mul32x32_64(h2, s3) + mul32x32_64(h3, s2) +
                      mul32x32_64(h4, s1);
            var tp1 = mul32x32_64(h0, r1) + mul32x32_64(h1, r0) + mul32x32_64(h2, s4) + mul32x32_64(h3, s3) +
                      mul32x32_64(h4, s2);
            var tp2 = mul32x32_64(h0, r2) + mul32x32_64(h1, r1) + mul32x32_64(h2, r0) + mul32x32_64(h3, s4) +
                      mul32x32_64(h4, s3);
            var tp3 = mul32x32_64(h0, r3) + mul32x32_64(h1, r2) + mul32x32_64(h2, r1) + mul32x32_64(h3, r0) +
                      mul32x32_64(h4, s4);
            var tp4 = mul32x32_64(h0, r4) + mul32x32_64(h1, r3) + mul32x32_64(h2, r2) + mul32x32_64(h3, r1) +
                      mul32x32_64(h4, r0);
