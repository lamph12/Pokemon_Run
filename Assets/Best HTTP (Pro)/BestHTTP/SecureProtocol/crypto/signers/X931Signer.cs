...
namespace Org.BouncyCastle.Crypto.Signers
{
        ...
        : ISigner
    {
        ...
        public virtual byte[] GenerateSignature()
        {
            ...
            var t = new BigInteger(1, cipher.ProcessBlock(block, 0, block.Length));
            ClearBlock(block);
        ...
        public virtual bool VerifySignature(byte[] signature)
        {
            ...
            var fBlock = BigIntegers.AsUnsignedByteArray(block.Length, f);

            var rv = Arrays.ConstantTimeAreEqual(block, fBlock);
        ...
        private void CreateSignatureBlock()
        {
            ...
            block[0] = 0x6b;
            for (var i = delta - 2; i != 0; i--) block[i] = 0xbb;
            block[delta - 1] = 0xba;
        }
    }
}
