...
namespace Org.BouncyCastle.Crypto.Signers
{
        ...
        : ISigner
    {
        ...
        private readonly byte[] mDash;
        private readonly int mgfhLen;

        private SecureRandom random;
        private readonly byte[] salt;
        private readonly int sLen;
        private readonly bool sSet;
        private readonly byte trailer;
            ...
            ICipherParameters parameters)
        {
            ...
            {
                if (forSigning) random = new SecureRandom();
            }
        ...
        public virtual byte[] GenerateSignature()
        {
            ...
            for (var i = 0; i != dbMask.Length; i++) block[i] ^= dbMask[i];
        ...
        public static PssSigner CreateRawSigner(
            ...
            IDigest digest)
        {
            return new PssSigner(cipher, new NullDigest(), digest, digest, digest.GetDigestSize(), null,
                TrailerImplicit);
        }
