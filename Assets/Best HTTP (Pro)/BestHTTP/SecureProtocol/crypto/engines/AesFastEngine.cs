...
namespace Org.BouncyCastle.Crypto.Engines
{
        ...
        */
            ...
            int outOff)
        {
            ...
            unsafe
            {
                ...
                {
                    C0 =
 (uint)pbytes[inOff] | (uint)pbytes[inOff + 1] << 8 | (uint)pbytes[inOff + 2] << 16 | (uint)pbytes[inOff + 3] << 24;
                    C1 =
 (uint)pbytes[inOff + 4] | (uint)pbytes[inOff + 5] << 8 | (uint)pbytes[inOff + 6] << 16 | (uint)pbytes[inOff + 7] << 24;
                    C2 =
 (uint)pbytes[inOff + 8] | (uint)pbytes[inOff + 9] << 8 | (uint)pbytes[inOff + 10] << 16 | (uint)pbytes[inOff + 11] << 24;
                    C3 =
 (uint)pbytes[inOff + 12] | (uint)pbytes[inOff + 13] << 8 | (uint)pbytes[inOff + 14] << 16 | (uint)pbytes[inOff + 15] << 24;
                }
            }
                    ...
                    fixed (uint* pT3 = T3)
                    {
                        while (r < ROUNDS - 1)
                        {
                            fixed (uint* pkw = WorkingKey[r++])
                            {
                                //kw = KW[r++];
                                r0 =
 pT0[t0 & 255] ^ pT1[(t1 >> 8) & 255] ^ pT2[(t2 >> 16) & 255] ^ pT3[r3 >> 24] ^ pkw[0];
                                r1 =
 pT0[t1 & 255] ^ pT1[(t2 >> 8) & 255] ^ pT2[(r3 >> 16) & 255] ^ pT3[t0 >> 24] ^ pkw[1];
                                r2 =
 pT0[t2 & 255] ^ pT1[(r3 >> 8) & 255] ^ pT2[(t0 >> 16) & 255] ^ pT3[t1 >> 24] ^ pkw[2];
                                r3 =
 pT0[r3 & 255] ^ pT1[(t0 >> 8) & 255] ^ pT2[(t1 >> 16) & 255] ^ pT3[t2 >> 24] ^ pkw[3];
                            }
                            ...
                            fixed (uint* pkw = WorkingKey[r++])
                            {
                                //kw = KW[r++];
                                t0 =
 pT0[r0 & 255] ^ pT1[(r1 >> 8) & 255] ^ pT2[(r2 >> 16) & 255] ^ pT3[r3 >> 24] ^ pkw[0];
                                t1 =
 pT0[r1 & 255] ^ pT1[(r2 >> 8) & 255] ^ pT2[(r3 >> 16) & 255] ^ pT3[r0 >> 24] ^ pkw[1];
                                t2 =
 pT0[r2 & 255] ^ pT1[(r3 >> 8) & 255] ^ pT2[(r0 >> 16) & 255] ^ pT3[r1 >> 24] ^ pkw[2];
                                r3 =
 pT0[r3 & 255] ^ pT1[(r0 >> 8) & 255] ^ pT2[(r1 >> 16) & 255] ^ pT3[r2 >> 24] ^ pkw[3];
                            }
                        }
                    ...
                    fixed (byte* pS = S)
                    {
                        ...
                        //kw = KW[r];
                        this.C0 =
 (uint)pS[r0 & 255] ^ (((uint)pS[(r1 >> 8) & 255]) << 8) ^ (((uint)pS[(r2 >> 16) & 255]) << 16) ^ (((uint)pS[r3 >> 24]) << 24) ^ pkw[0];
                        this.C1 =
 (uint)pS[r1 & 255] ^ (((uint)pS[(r2 >> 8) & 255]) << 8) ^ (((uint)pS[(r3 >> 16) & 255]) << 16) ^ (((uint)pS[r0 >> 24]) << 24) ^ pkw[1];
                        this.C2 =
 (uint)pS[r2 & 255] ^ (((uint)pS[(r3 >> 8) & 255]) << 8) ^ (((uint)pS[(r0 >> 16) & 255]) << 16) ^ (((uint)pS[r1 >> 24]) << 24) ^ pkw[2];
                        this.C3 =
 (uint)pS[r3 & 255] ^ (((uint)pS[(r0 >> 8) & 255]) << 8) ^ (((uint)pS[(r1 >> 16) & 255]) << 16) ^ (((uint)pS[r2 >> 24]) << 24) ^ pkw[3];
                    }
                }
            }
            else
                    ...
                    fixed (uint* pTinv3 = Tinv3)
                        while (r > 1)
                        {
                            fixed (uint* pkw = WorkingKey[r--])
                            {
                                //kw = KW[r--];
                                r0 =
 pTinv0[t0 & 255] ^ pTinv1[(r3 >> 8) & 255] ^ pTinv2[(t2 >> 16) & 255] ^ pTinv3[t1 >> 24] ^ pkw[0];
                                r1 =
 pTinv0[t1 & 255] ^ pTinv1[(t0 >> 8) & 255] ^ pTinv2[(r3 >> 16) & 255] ^ pTinv3[t2 >> 24] ^ pkw[1];
                                r2 =
 pTinv0[t2 & 255] ^ pTinv1[(t1 >> 8) & 255] ^ pTinv2[(t0 >> 16) & 255] ^ pTinv3[r3 >> 24] ^ pkw[2];
                                r3 =
 pTinv0[r3 & 255] ^ pTinv1[(t2 >> 8) & 255] ^ pTinv2[(t1 >> 16) & 255] ^ pTinv3[t0 >> 24] ^ pkw[3];
                            }
                            ...
                            fixed (uint* pkw = WorkingKey[r--])
                            {
                                //kw = KW[r--];
                                t0 =
 pTinv0[r0 & 255] ^ pTinv1[(r3 >> 8) & 255] ^ pTinv2[(r2 >> 16) & 255] ^ pTinv3[r1 >> 24] ^ pkw[0];
                                t1 =
 pTinv0[r1 & 255] ^ pTinv1[(r0 >> 8) & 255] ^ pTinv2[(r3 >> 16) & 255] ^ pTinv3[r2 >> 24] ^ pkw[1];
                                t2 =
 pTinv0[r2 & 255] ^ pTinv1[(r1 >> 8) & 255] ^ pTinv2[(r0 >> 16) & 255] ^ pTinv3[r3 >> 24] ^ pkw[2];
                                r3 =
 pTinv0[r3 & 255] ^ pTinv1[(r2 >> 8) & 255] ^ pTinv2[(r1 >> 16) & 255] ^ pTinv3[r0 >> 24] ^ pkw[3];
                            }
 ...
 pTinv0[r3 & 255] ^ pTinv1[(t2 >> 8) & 255] ^ pTinv2[(t1 >> 16) & 255] ^ pTinv3[t0 >> 24] ^ pkw[3];
                    ...
                    fixed (byte* pSi = Si)
                    {
                        //kw = KW[0];
                        this.C0 =
 (uint)pSi[r0 & 255] ^ (((uint)pSi[(r3 >> 8) & 255]) << 8) ^ (((uint)pSi[(r2 >> 16) & 255]) << 16) ^ (((uint)pSi[r1 >> 24]) << 24) ^ pkw[0];
                        this.C1 =
 (uint)pSi[r1 & 255] ^ (((uint)pSi[(r0 >> 8) & 255]) << 8) ^ (((uint)pSi[(r3 >> 16) & 255]) << 16) ^ (((uint)pSi[r2 >> 24]) << 24) ^ pkw[1];
                        this.C2 =
 (uint)pSi[r2 & 255] ^ (((uint)pSi[(r1 >> 8) & 255]) << 8) ^ (((uint)pSi[(r0 >> 16) & 255]) << 16) ^ (((uint)pSi[r3 >> 24]) << 24) ^ pkw[2];
                        this.C3 =
 (uint)pSi[r3 & 255] ^ (((uint)pSi[(r2 >> 8) & 255]) << 8) ^ (((uint)pSi[(r1 >> 16) & 255]) << 16) ^ (((uint)pSi[r0 >> 24]) << 24) ^ pkw[3];
                    }
                }
            }
