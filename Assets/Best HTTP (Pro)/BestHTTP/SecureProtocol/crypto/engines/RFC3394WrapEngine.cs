...
namespace Org.BouncyCastle.Crypto.Engines
{
        ...
        : IWrapper
    {
            ...
            int inLen)
        {
            ...
            if (n * 8 != inLen) throw new DataLengthException("wrap data must be a multiple of 8 bytes");
            ...
            int inLen)
        {
            ...
            if (n * 8 != inLen) throw new InvalidCipherTextException("unwrap data must be a multiple of 8 bytes");
