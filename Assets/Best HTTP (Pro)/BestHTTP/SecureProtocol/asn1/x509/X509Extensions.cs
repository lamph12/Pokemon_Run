...
namespace Org.BouncyCastle.Asn1.X509
{
        ...
        : Asn1Encodable
    {
            ...
            IDictionary extensions)
        {
            ...
            foreach (DerObjectIdentifier oid in this.ordering) this.extensions.Add(oid, (X509Extension)extensions[oid]);
        }
            ...
            IList values)
        {
            ...
            var count = 0;
            foreach (DerObjectIdentifier oid in ordering) extensions.Add(oid, (X509Extension)values[count++]);
        }
        ...
        public static X509Extensions GetInstance(
            object obj)
        {
            if (obj == null || obj is X509Extensions) return (X509Extensions)obj;

            if (obj is Asn1Sequence) return new X509Extensions((Asn1Sequence)obj);
        ...
        public override Asn1Object ToAsn1Object()
        {
            ...
            foreach (DerObjectIdentifier oid in ordering)
            {
                ...
                if (ext.IsCritical) v.Add(DerBoolean.True);
        ...
        private DerObjectIdentifier[] GetExtensionOids(bool isCritical)
        {
            ...
            {
                var ext = (X509Extension)extensions[oid];
                if (ext.IsCritical == isCritical) oids.Add(oid);
            }
