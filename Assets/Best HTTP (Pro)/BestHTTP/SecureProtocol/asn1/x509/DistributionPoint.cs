...
namespace Org.BouncyCastle.Asn1.X509
{
        ...
        : Asn1Encodable
    {
            ...
            Asn1Sequence seq)
        {
            ...
            {
                var t = Asn1TaggedObject.GetInstance(seq[i]);
        ...
        public static DistributionPoint GetInstance(
            object obj)
        {
            if (obj == null || obj is DistributionPoint) return (DistributionPoint)obj;

            if (obj is Asn1Sequence) return new DistributionPoint((Asn1Sequence)obj);
        ...
        public override Asn1Object ToAsn1Object()
        {
            ...
            if (reasons != null) v.Add(new DerTaggedObject(false, 1, reasons));

            if (cRLIssuer != null) v.Add(new DerTaggedObject(false, 2, cRLIssuer));
        ...
        public override string ToString()
        {
            ...
            if (reasons != null) appendObject(buf, sep, "reasons", reasons.ToString());
            if (cRLIssuer != null) appendObject(buf, sep, "cRLIssuer", cRLIssuer.ToString());
            buf.Append("]");
            buf.Append(sep);
            return buf.ToString();
        }
