...
namespace Org.BouncyCastle.Asn1.Sec
{
    public sealed class SecNamedCurves
    {
            ...
            : X9ECParametersHolder
        {
            ...
            {
                // p = (2^128 - 3) / 76439
                var p = FromHex("DB7C2ABF62E35E668076BEAD208B");
                var a = FromHex("DB7C2ABF62E35E668076BEAD2088");
                var b = FromHex("659EF8BA043916EEDE8911702B22");
                var S = Hex.Decode("00F50B028E4D696E676875615175290472783FB1");
                var n = FromHex("DB7C2ABF62E35E7628DFAC6561C5");
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                // p = (2^128 - 3) / 76439
                var p = FromHex("DB7C2ABF62E35E668076BEAD208B");
                var a = FromHex("6127C24C05F38A0AAAF65C0EF02C");
                var b = FromHex("51DEF1815DB5ED74FCC34C85D709");
                var S = Hex.Decode("002757A1114D696E6768756151755316C05E0BD4");
                var n = FromHex("36DF0AAFD8B8D7597CA10520D04B");
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var S = Hex.Decode("000E0D4D696E6768756151750CC03A4473D03679");
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                // p = 2^128 - 2^97 - 1
                var p = FromHex("FFFFFFFDFFFFFFFFFFFFFFFFFFFFFFFF");
                var a = FromHex("D6031998D1B3BBFEBF59CC9BBFF9AEE1");
                var b = FromHex("5EEEFCA380D02919DC2C6558BB6D8A5D");
                var S = Hex.Decode("004D696E67687561517512D8F03431FCE63B88F4");
                var n = FromHex("3FFFFFFF7FFFFFFFBE0024720613B5A3");
                var h = BigInteger.ValueOf(4);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var curve = ConfigureCurveGlv(new FpCurve(p, a, b, n, h), glv);
                var G = new X9ECPoint(curve, Hex.Decode("04"
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var S = Hex.Decode("1053CDE42C14D696E67687561517533BF3F83345");
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                // p = 2^160 - 2^32 - 2^14 - 2^12 - 2^9 - 2^8 - 2^7 - 2^3 - 2^2 - 1
                var p = FromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC73");
                var a = FromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC70");
                var b = FromHex("B4E134D3FB59EB8BAB57274904664D5AF50388BA");
                var S = Hex.Decode("B99B99B099B323E02709A4D696E6768756151751");
                var n = FromHex("0100000000000000000000351EE786A818F3A1A16B");
                var h = BigInteger.One;
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var S = Hex.Decode("3045AE6FC8422F64ED579528D38120EAE12196D5");
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var p = FromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFE56D");
                var a = BigInteger.Zero;
                var b = BigInteger.ValueOf(5);
                byte[] S = null;
                var n = FromHex("010000000000000000000000000001DCE8D2EC6184CAF0A971769FB1F7");
                var h = BigInteger.One;
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var S = Hex.Decode("BD71344799D5C7FCDC45B59FA3B9AB8F6A948BC5");
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var S = Hex.Decode("C49D360886E704936A6678E1139D26B7819F7E90");
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var S = Hex.Decode("A335926AA319A27A1D00896A6773A4827ACDAC73");
                var n = FromHex(
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var S = Hex.Decode("D09E8800291CB85396CC6717393284AAA0DA64BA");
                var n = FromHex(
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                var a = FromHex("003088250CA6E7C7FE649CE85820F7");
                var b = FromHex("00E8BEE4D3E2260744188BE0E9C723");
                var S = Hex.Decode("10E723AB14D696E6768756151756FEBF8FCB49A9");
                var n = FromHex("0100000000000000D9CCEC8A39E56F");
                var h = BigInteger.ValueOf(2);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                var a = FromHex("00689918DBEC7E5A0DD6DFC0AA55C7");
                var b = FromHex("0095E9A9EC9B297BD4BF36E059184F");
                var S = Hex.Decode("10C0FB15760860DEF1EEF4D696E676875615175D");
                var n = FromHex("010000000000000108789B2496AF93");
                var h = BigInteger.ValueOf(2);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                var a = FromHex("07A11B09A76B562144418FF3FF8C2570B8");
                var b = FromHex("0217C05610884B63B9C6C7291678F9D341");
                var S = Hex.Decode("4D696E676875615175985BD3ADBADA21B43A97E2");
                var n = FromHex("0400000000000000023123953A9464B54D");
                var h = BigInteger.ValueOf(2);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                var a = FromHex("03E5A88919D7CAFCBF415F07C2176573B2");
                var b = FromHex("04B8266A46C55657AC734CE38F018F2192");
                var S = Hex.Decode("985BD3ADBAD4D696E676875615175A21B43A97E3");
                var n = FromHex("0400000000000000016954A233049BA98F");
                var h = BigInteger.ValueOf(2);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                var a = FromHex("07B6882CAAEFA84F9554FF8428BD88E246D2782AE2");
                var b = FromHex("0713612DCDDCB40AAB946BDA29CA91F73AF958AFD9");
                var S = Hex.Decode("24B7B137C8A14D696E6768756151756FD0DA2E5C");
                var n = FromHex("03FFFFFFFFFFFFFFFFFFFF48AAB689C29CA710279B");
                var h = BigInteger.ValueOf(2);
            ...
            : X9ECParametersHolder
        {
            ...
            {
                var a = BigInteger.One;
                var b = FromHex("020A601907B8C953CA1481EB10512F78744A3205FD");
                var S = Hex.Decode("85E25BFE5C86226CDB12016F7553F9D0E693A268");
                var n = FromHex("040000000000000000000292FE77E70C12A4234C33");
                var h = BigInteger.ValueOf(2);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                var a = FromHex("0017858FEB7A98975169E171F77B4087DE098AC8A911DF7B01");
                var b = FromHex("00FDFB49BFE6C3A89FACADAA7A1E5BBC7CC1C2E5D831478814");
                var S = Hex.Decode("103FAEC74D696E676875615175777FC5B191EF30");
                var n = FromHex("01000000000000000000000000C7F34A778F443ACC920EBA49");
                var h = BigInteger.ValueOf(2);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                var a = FromHex("0163F35A5137C2CE3EA6ED8667190B0BC43ECD69977702709B");
                var b = FromHex("00C9BB9E8927D4D64C377E2AB2856A5B16E3EFB7F61D4316AE");
                var S = Hex.Decode("10B7B4D696E676875615175137C8A16FD0DA2211");
                var n = FromHex("010000000000000000000000015AAB561B005413CCD4EE99D5");
                var h = BigInteger.ValueOf(2);
            ...
            : X9ECParametersHolder
        {
            ...
            {
                var a = BigInteger.One;
                var b = FromHex("0066647EDE6C332C7F8C0923BB58213B333B20E9CE4281FE115F7D8F90AD");
                var S = Hex.Decode("74D59FF07F6B413D0EA14B344B20A2DB049B50C3");
                var n = FromHex("01000000000000000000000000000013E974E72F8A6922031D2603CFE0D7");
                var h = BigInteger.ValueOf(2);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var b = BigInteger.One;
                byte[] S = null;
                var n = FromHex("2000000000000000000000000000005A79FEC67CB6E91F1C1DA800E478A5");
                var h = BigInteger.ValueOf(4);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var b = BigInteger.One;
                byte[] S = null;
                var n = FromHex("01FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE9AE2ED07577265DFF7F94451E061E163C61");
                var h = BigInteger.ValueOf(4);
            ...
            : X9ECParametersHolder
        {
            ...
            {
                var a = BigInteger.One;
                var b = FromHex("027B680AC8B8596DA5A4AF8A19A0303FCA97FD7645309FA2A581485AF6263E313B79A2F5");
                var S = Hex.Decode("77E2B07370EB0F832A6DD5B62DFC88CD06BB84BE");
                var n = FromHex("03FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEF90399660FC938A90165B042A7CEFADB307");
                var h = BigInteger.ValueOf(2);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var S = Hex.Decode("4099B5A457F9D69F79213D094C4BCD4D4262210B");
                var n = FromHex(
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                var S = Hex.Decode("2AA058F73A0E33AB486B0F610410C53A7F132310");
                var n = FromHex(
