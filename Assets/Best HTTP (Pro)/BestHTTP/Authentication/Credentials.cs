namespace BestHTTP.Authentication
{
    ...
    ///     The authentication is defined by the server, so the Basic and Digest are not interchangeable. If you don't know
    ///     what to use, the preferred way is to choose Unknow.
    /// </summary>
    ...
    public sealed class Credentials
    {
        ...
        /// </summary>
        public AuthenticationTypes Type { get; }
