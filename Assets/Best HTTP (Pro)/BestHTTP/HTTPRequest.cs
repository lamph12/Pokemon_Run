...
namespace BestHTTP
{
    ...
    public enum HTTPRequestStates
    {
        ...
        /// <summary>
        ///     Processing of the request started. In this state the client will send the request, and parse the response. No
        ///     callback will be called with this status.
        /// </summary>
        Processing,

        /// <summary>
        ///     The request finished without problem. Parsing the response done, the result can be used. The user defined callback
        ///     will be called with a valid response object. The request’s Exception property will be null.
        /// </summary>
        Finished,

        /// <summary>
        ///     The request finished with an unexpected error. The user defined callback will be called with a null response
        ///     object. The request's Exception property may contain more info about the error, but it can be null.
        /// </summary>
        Error,

        /// <summary>
        ///     The request aborted by the client(HTTPRequest’s Abort() function). The user defined callback will be called with a
        ///     null response. The request’s Exception property will be null.
        /// </summary>
        Aborted,

        /// <summary>
        ///     Connecting to the server timed out. The user defined callback will be called with a null response. The request’s
        ///     Exception property will be null.
        /// </summary>
        ConnectionTimedOut,

        /// <summary>
        ///     The request didn't finished in the given time. The user defined callback will be called with a null response. The
        ///     request’s Exception property will be null.
        /// </summary>
        TimedOut
    }
    ...
    public sealed class HTTPRequest : IEnumerator, IEnumerator<HTTPRequest>
    {
        ...
        public void Abort()
        {
            if (Monitor.TryEnter(HTTPManager.Locker, TimeSpan.FromMilliseconds(100)))
                try
                {
                    if (State >= HTTPRequestStates.Finished)
                    {
                        HTTPManager.Logger.Warning("HTTPRequest",
                            string.Format("Abort - Already in a state({0}) where no Abort required!",
                                State.ToString()));
                    ...
                    if (connection == null)
                    {
                        ...
                        if (!HTTPManager.RemoveFromQueue(this))
                            HTTPManager.Logger.Warning("HTTPRequest",
                                "Abort - No active connection found with this request! (The request may already finished?)");
        ...
        {
            HTTPManager.Logger.Verbose("HTTPRequest", "'" + CurrentUri + "' - " + str);
        }
        ...
        /// <summary>
        ///     Size of the internal buffer, and upload progress will be fired when this size of data sent to the wire. It's
        ...
        /// <summary>
        ///     The stream that the plugin will use to get the data to send out the server. When this property is set, no forms or
        ///     the RawData property will be used
        /// </summary>
        public Stream UploadStream { get; set; }

        /// <summary>
        ///     When set to true(its default value) the plugin will call the UploadStream's Dispose() function when finished
        ///     uploading the data from it. Default value is true.
        /// </summary>
        public bool DisposeUploadStream { get; set; }

        /// <summary>
        ///     If it's true, the plugin will use the Stream's Length property. Otherwise the plugin will send the data chunked.
        ...
        /// <summary>
        ///     Indicates that the connection should be open after the response received. If its true, then the internal TCP
        ///     connections will be reused if it's possible. Default value is true.
        ///     The default value can be changed in the HTTPManager class. If you make rare request to the server it's should be
        ///     changed to false.
        /// </summary>
        ...
        public bool UseStreaming
        {
            ...
            set
            {
                if (State == HTTPRequestStates.Processing)
                    throw new NotSupportedException(
                        "Changing the UseStreaming property while processing the request is not supported.");
                useStreaming = value;
            }
        }
        ...
        /// <summary>
        ///     The callback function that will be called when a request is fully processed or when any downloaded fragment is
        ///     available if UseStreaming is true. Can be null for fire-and-forget requests.
        /// </summary>
        public OnRequestFinishedDelegate Callback { get; set; }

        /// <summary>
        ///     Called when new data downloaded from the server.
        ///     The first parameter is the original HTTTPRequest object itself, the second parameter is the downloaded bytes while
        ///     the third parameter is the content length.
        ///     <remarks>
        ///         There are download modes where we can't figure out the exact length of the final content. In these cases
        ///         we just guarantee that the third parameter will be at least the size of the second one.
        ///     </remarks>
        /// </summary>
        ...
        /// <summary>
        ///     With this option if reading back the server's response fails, the request will fail and any exceptions can be
        ///     checked through the Exception property. The default value is True for POST requests, otherwise false.
        /// </summary>
        public bool DisableRetry { get; set; }

        /// <summary>
        ///     Indicates that the request is redirected. If a request is redirected, the connection that served it will be closed
        ///     regardless of the value of IsKeepAlive.
        /// </summary>
        ...
        ///     <remarks>
        ///         If an exception occurred during reading of the response stream or can't connect to the server, this will
        ///         be null!
        ///     </remarks>
        /// </summary>
        ...
        /// <summary>
        ///     It there is an exception while processing the request or response the Response property will be null, and the
        ///     Exception will be stored in this property.
        /// </summary>
        ...
        /// <summary>
        ///     How many redirection supported for this request. The default is int.MaxValue. 0 or a negative value means no
        ...
        /// <summary>
        ///     Use Bouncy Castle's code to handle the secure protocol instead of Mono's. You can try to set it true if you receive
        ///     a "System.Security.Cryptography.CryptographicException: Unsupported hash algorithm" exception.
        /// </summary>
        ...
        /// <summary>
        ///     If true cookies will be added to the headers (if any), and parsed from the response. If false, all cookie
        ///     operations will be ignored. It's default value is HTTPManager's IsCookiesEnabled.
        /// </summary>
        public bool IsCookiesEnabled { get; set; }

        /// <summary>
        ///     Cookies that are added to this list will be sent to the server alongside withe the server sent ones. If cookies are
        ///     disabled only these cookies will be sent.
        /// </summary>
        ...
        /// <summary>
        ///     Custom validator for an SslStream. This event will receive the original HTTPRequest, an X509Certificate and an
        ///     X509Chain objects. It must return true if the certificate valid, false otherwise.
        ...
        /// <summary>
        ///     Maximum time we wait to establish the connection to the target server. If set to TimeSpan.Zero or lower, no connect
        ///     timeout logic is executed. Default value is 20 seconds.
        /// </summary>
        public TimeSpan ConnectTimeout { get; set; }

        /// <summary>
        ///     Maximum time we want to wait to the request to finish after the connection is established. Default value is 60
        ///     seconds.
        ...
        /// <summary>
        ///     The priority of the request. Higher priority requests will be picked from the request queue sooner than lower
        ///     priority ones.
        /// </summary>
...
#if !BESTHTTP_DISABLE_ALTERNATE_SSL && (!UNITY_WEBGL || UNITY_EDITOR)
        /// <summary>
        ///     The ICertificateVerifyer implementation that the plugin will use to verify the server certificates when the
        ///     request's UseAlternateSSL property is set to true.
        /// </summary>
        public ICertificateVerifyer CustomCertificateVerifyer { get; set; }

        /// <summary>
        ///     The IClientCredentialsProvider implementation that the plugin will use to send client certificates when the
        ///     request's UseAlternateSSL property is set to true.
        /// </summary>
        ...
        ///     All added entries must conform to the rules defined in the RFC (https://tools.ietf.org/html/rfc3546#section-3.1),
        ///     the plugin will not check the entries' validity!
        ///     <remarks>
        ...
        /// <summary>
        ///     It's called before the plugin will do a new request to the new uri. The return value of this function will control
        ///     the redirection: if it's false the redirection is aborted.
        ...
        /// <summary>
        ///     This event will be fired before the plugin will write headers to the wire. New headers can be added in this
        ///     callback. This event is called on a non-Unity thread!
        /// </summary>
        ...
        /// <summary>
        ///     Setting this option to true, the processing connection will set the TCP NoDelay option to send out data as soon as
        ///     it can.
        /// </summary>
        ...
        /// <summary>
        ///     When the request about to send the request we will create a specialized form implementation(url-encoded, multipart,
        ///     or the legacy WWWForm based).
        ...
        /// <summary>
        ///     Sets the Range header to download the content from the given byte position. See
        ...
        /// <summary>
        ///     Sets the Range header to download the content from the given byte position to the given last position. See
        ///     http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.35
        /// </summary>
        /// <param name="firstBytePos">Start position of the download.</param>
        ...
        public void EnumerateHeaders(OnHeaderEnumerationDelegate callback, bool callBeforeSendCallback)
        {
            ...
            if (Credentials != null)
                switch (Credentials.Type)
                {
                    ...
                    case AuthenticationTypes.Unknown:
                    case AuthenticationTypes.Digest:
                        var digest = DigestStore.Get(CurrentUri);
                        if (digest != null)
                        {
            ...
            else if (customCookies != null)
            {
                ...
                {
                    var customCookie = customCookies[idx];
        ...
        private void SendHeaders(Stream stream)
        {
            EnumerateHeaders((header, values) =>
            {
                ...
                for (var i = 0; i < values.Count; ++i)
                {
                    ...
                    {
                        HTTPManager.Logger.Warning("HTTPRequest",
                            string.Format("Null/empty value for header: {0}", header));
                        continue;
                    }
        ...
        internal void SendOutTo(Stream stream)
        {
            ...
            {
#if !UNITY_WEBGL || UNITY_EDITOR
                var requestPathAndQuery =
#if !BESTHTTP_DISABLE_PROXY
                    HasProxy && Proxy.SendWholeUri
                        ? CurrentUri.OriginalString
                        :
#endif
                        CurrentUri.GetRequestPathAndQueryURL();

                var requestLine = string.Format("{0} {1} HTTP/1.1", MethodNames[(byte)MethodType], requestPathAndQuery);
