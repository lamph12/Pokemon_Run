namespace BestHTTP
{
    ...
    public enum HTTPMethods : byte
    {
        ...
        ///     This method can be used for obtaining metainformation about the entity implied by the request without transferring
        ...
        ///     <list type="bullet">
        ///         <item>
        ///             <description>Annotation of existing resources;</description>
        ///         </item>
        ///         <item>
        ///             <description>Posting a message to a bulletin board, newsgroup, mailing list, or similar group of articles;</description>
        ///         </item>
        ///         <item>
        ///             <description>
        ...
        ///         </item>
        ///         <item>
        ///             <description>Extending a database through an append operation.</description>
        ///         </item>
        ///     </list>
        ...
        ///     resource by the requesting user agent,
        ...
        ///     The recipient of the entity MUST NOT ignore any Content-* (e.g. Content-Range) headers that it does not understand
        ...
        ///     The client cannot be guaranteed that the operation has been carried out, even if the status code returned from the
        ///     origin server indicates that the action has been completed successfully.
        ///     However, the server SHOULD NOT indicate success unless, at the time the response is given, it intends to delete the
        ...
        ///     The set of changes is represented in a format called a "patchdocument" identified by a media type. If the
        ///     Request-URI does not point to an existing resource,
        ///     the server MAY create a new resource, depending on the patch document type (whether it can logically modify a null
