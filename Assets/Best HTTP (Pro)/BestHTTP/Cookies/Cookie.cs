...
namespace BestHTTP.Cookies
{
    ...
    public sealed class Cookie : IComparable<Cookie>, IEquatable<Cookie>
    {
        ...
        /// <summary>
        ///     The Expires attribute indicates the maximum lifetime of the cookie, represented as the date and time at which the
        ///     cookie expires.
        ...
        /// <summary>
        ///     The Max-Age attribute indicates the maximum lifetime of the cookie, represented as the number of seconds until the
        ///     cookie expires.
        ...
        /// <summary>
        ///     If a cookie has neither the Max-Age nor the Expires attribute, the user agent will retain the cookie until "the
        ...
        ///     If the server omits the Path attribute, the user agent will use the "directory" of the request-uri's path component
        ///     as the default value.
        /// </summary>
        public string Path { get; private set; }

        /// <summary>
        ///     The Secure attribute limits the scope of the cookie to "secure" channels (where "secure" is defined by the user
        ///     agent).
        ///     When a cookie has the Secure attribute, the user agent will include the cookie in an HTTP request only if the
        ///     request is
        ...
        public bool Equals(Cookie cookie)
        {
            ...
            return Name.Equals(cookie.Name, StringComparison.Ordinal) &&
                   ((Domain == null && cookie.Domain == null) ||
        ...
        private static List<HeaderValue> ParseCookieHeader(string str)
        {
            ...
            {
                // Read key
                var key = str.Read(ref idx, ch => ch != '=' && ch != ';').Trim();
