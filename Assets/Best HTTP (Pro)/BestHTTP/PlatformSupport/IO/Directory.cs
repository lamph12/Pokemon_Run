...
namespace BestHTTP.PlatformSupport.IO
{
    public static class Directory
    {
        ...
        public static IEnumerable<string> EnumerateDirectories(string path)
        {
            ...
            try
            {
                IAsyncOperation<IReadOnlyList<StorageFolder>> foldersAsync =
 Directory.GetDirectoryForPath(path).GetFoldersAsync();
                WindowsRuntimeSystemExtensions.AsTask<IReadOnlyList<StorageFolder>>(foldersAsync).Wait();
                IReadOnlyList<StorageFolder> results = foldersAsync.GetResults();
                List<string> list =
 new List<string>(Enumerable.Count<StorageFolder>((IEnumerable<StorageFolder>)results));
        ...
        public static IEnumerable<string> EnumerateFiles(string path)
        {
            ...
            try
            {
                IAsyncOperation<IReadOnlyList<StorageFile>> filesAsync =
 Directory.GetDirectoryForPath(path).GetFilesAsync();
                WindowsRuntimeSystemExtensions.AsTask<IReadOnlyList<StorageFile>>(filesAsync).Wait();
