...
namespace AppsFlyerSDK
{
    ...
    public class AppsFlyerAndroid
    {
        ...
        ///     The current game object. This is used to get the conversion data callbacks. Pass null if you
        ///     do not need the callbacks.
        /// </param>
        ...
        ///     If this API is used, all in-app events and any other SDK API calls are discarded, until the customerUserID is
        ///     provided.
        /// </summary>
        ...
        /// <summary>
        ///     Use this API to provide the SDK with the relevant customer user id and trigger the SDK to begin its normal
        ///     activity.
        /// </summary>
        /// <param name="id">Customer ID for client.</param>
        ...
        ///     However, apps with Google play services should avoid Android ID collection as this is in violation of the Google
        ///     Play policy.
        /// </summary>
        ...
        ///     However, apps with Google play services should avoid IMEI collection as this is in violation of the Google Play
        ///     policy.
        /// </summary>
        /// <param name="isCollect">boolean, false to opt-out.</param>
        ...
        public static void sendEvent(string eventName, Dictionary<string, string> eventValues, bool shouldCallback,
        ...
        ///     Otherwise deep re-occurring deep-links will be permitted for non-singleTask Activities and deep-linking via
        ...
        ///     <code>data.INAPP_DATA_SIGNATURE</code> from
        ///     <code>onActivityResult(int requestCode, int resultCode, Intent data)</code>
        /// </param>
        /// <param name="purchaseData">
        ///     <code>data.INAPP_PURCHASE_DATA</code> from
        ///     <code>onActivityResult(int requestCode, int resultCode, Intent data)</code>
        /// </param>
        /// <param name="price">
        ///     Purchase price, should be derived from <code>skuDetails.getStringArrayList("DETAILS_LIST")</code>
        /// </param>
        /// <param name="currency">
        ///     Purchase currency, should be derived from
        ///     <code>skuDetails.getStringArrayList("DETAILS_LIST")</code>
        /// </param>
        /// <param name="additionalParameters">
        ///     additionalParameters Freehand parameters to be sent with the purchase (if
        ///     validated).
        /// </param>
        public static void validateAndSendInAppPurchase(string publicKey, string signature, string purchaseData,
            string price, string currency, Dictionary<string, string> additionalParameters, MonoBehaviour gameObject)
        {
#if !UNITY_EDITOR
        ...
        public static void attributeAndOpenStore(string promoted_app_id, string campaign,
        ...
        /// <summary>
        ///     Disables collection of various Advertising IDs by the SDK. This includes Google Advertising ID (GAID), OAID and
        ...
        {
            var emailsCryptTypeEnum = new AndroidJavaClass("com.appsflyer.AppsFlyerProperties$EmailsCryptType");
        ...
        private static AndroidJavaObject convertDictionaryToJavaMap(Dictionary<string, string> dictionary)
        {
            ...
            var putMethod = AndroidJNIHelper.GetMethodID(map.GetRawClass(), "put",
